...
export default async function handler(req, res) {
  try {
    ...
    const strictPrompt = `
      Create a simple, black-and-white line art coloring page designed for children aged 5-10.
      The illustration must visually represent the concept of "${word}" without including:
      - Any form of text, symbols, letters, numbers, or characters (e.g., Chinese or English words).
      - Any textual hints or implicit representations of the word.
      
      Requirements:
      - Use bold, simple outlines and visually distinct details.
      - The design must be purely illustrative, playful, and child-friendly.
      - Avoid overly complex or crowded designs.
      - Do not include any hidden text or symbols.

      Generate a creative, engaging scene that children can enjoy coloring, focusing entirely on visuals to convey the concept. Any inclusion of text or symbols will make the result invalid.
    `;
