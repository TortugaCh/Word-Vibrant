  ...
  return (
    <Template>
      <div className="relative flex flex-col items-center overflow-hidden">
        ...
        <section className="container mx-auto px-6 py-24 text-center">
          <h3 className="text-4xl font-bold text-[#7E57C2] mb-8">{t('aboutTitle')}</h3>
          <p className="text-gray-600 text-lg">{t('aboutDescription')}</p>
        </section>

        <section className="container mx-auto px-6 py-20 text-center">
          <h3 className="text-4xl font-bold text-purple-700 mb-12">{t('choosePlan')}</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            {[
              ...
              <div key={index} className="p-10 bg-gradient-to-b from-blue-100 to-blue-200 rounded-3xl shadow-lg">
                <h4 className="text-3xl font-bold">{plan.name}</h4>
                <p className="text-gray-700">{plan.credits} {t('credits')}</p>
                {plan.cost > 0 && <p className="text-gray-700">NT${plan.cost}</p>}
