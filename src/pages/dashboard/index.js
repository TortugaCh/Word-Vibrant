    ...
    <Template title={t("dashboardTitle")} userData={userData}>
      <main className="container mx-auto px-6 py-3 mt-5 relative z-10 flex flex-col items-center">
        <div className="max-w-4xl w-full p-8 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <DashboardOptionCard
              title={t("strokeOrdersTitle")}
              description={t("strokeOrdersDescription")}
              color="bg-blue-100 border-blue-200"
              icon="✍️"
              route="/strokeOrders"
            />
            <DashboardOptionCard
              title={t("coloringPageTitle")}
              description={t("coloringPageDescription")}
              color="bg-green-100 border-green-200"
              icon="🎨"
              route="/coloringPage"
            />
            ...
            />
            <DashboardOptionCard
              title={t("createDialogueTitle")}
              description={t("createDialogueDescription")}
              color="bg-pink-100 border-pink-200"
              icon="💬"
              route="/createDialogue"
            />
